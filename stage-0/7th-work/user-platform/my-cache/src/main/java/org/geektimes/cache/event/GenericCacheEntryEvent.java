 ...
 *
 *  通用事件实体（本质是 eventObject 子类）
 *  通过构造器和参数（Cache source, EventType eventType, K key, V oldValue, V value）生成对象
 *  主要目的 提供 static方法 和 构造器，实现快速生成CREATED UPDATED EXPIRED REMOVED类型事件对象
 *
