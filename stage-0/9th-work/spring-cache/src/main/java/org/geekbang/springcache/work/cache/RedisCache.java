...
public class RedisCache implements Cache {
    ...
    public String prefixKey(Object key) {
        return name + ":" + key;
    }

    @Override
    public ValueWrapper get(Object key) {
        byte[] keyBytes = serialize(prefixKey(key));
...
//        jedis.scan()
    ...
    private byte[] serialize(Object value) throws JedisException {
        byte[] bytes = null;
    ...
    private <T> T deserialize(byte[] bytes) throws JedisException {
        if (bytes == null) {
            return null;
        }
        T value = null;
